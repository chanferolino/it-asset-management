...
export function DepartmentSummary({ allocations }: DepartmentSummaryProps) {
  ...
  return (
    <div className="flex flex-wrap gap-4">
      {/* Total card */}
      <div className="min-w-[140px] flex-1 rounded-2xl border border-[#c80000]/20 bg-[#c80000]/[0.06] p-5 backdrop-blur-xl">
      ...
      {allocations.map((item) => (
        <div
          key={item.department}
          className="min-w-[140px] flex-1 rounded-2xl border border-white/80 bg-white/70 p-5 shadow-lg shadow-black/[0.04] backdrop-blur-xl transition-all hover:shadow-xl hover:shadow-black/[0.08]"
        >
